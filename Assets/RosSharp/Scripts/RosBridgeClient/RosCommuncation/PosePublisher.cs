...
{
    public class PosePublisher : Publisher<Messages.Geometry.Twist>
    {
        ...
        private void UpdateMessage()
        {
            ...
            Vector3 linearVelocity = PublishedTransform.position;
            Vector3 angularVelocity = PublishedTransform.rotation.eulerAngles;
